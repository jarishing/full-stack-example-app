...
describe("Error Handling System", () => {
  ...
  describe("ApiError", () => {
    ...
    it("should accept additional properties", () => {
      ...
      expect(error.message).toBe(message);
      expect(error.statusCode).toBe(statusCode);
      expect((error as any).field).toBe(details.field);
      expect((error as any).reason).toBe(details.reason);
    });
  });
  ...
  describe("HTTP Status Error Classes", () => {
    ...
    describe("ApiErrorUnauthorized (401)", () => {
      ...
      it("should handle token-related errors", () => {
        ...
        expect(error.statusCode).toBe(401);
        expect((error as any).tokenType).toBe("JWT");
    ...
    describe("ApiErrorForbidden (403)", () => {
      ...
      it("should handle permission-related errors", () => {
        ...
        expect(error.statusCode).toBe(403);
        expect((error as any).requiredPermission).toBe("admin");
        expect((error as any).userPermissions).toEqual(["user"]);
      });
    });
    ...
    describe("ApiErrorNotFound (404)", () => {
      ...
      it("should handle resource-specific errors", () => {
        ...
        expect(error.statusCode).toBe(404);
        expect((error as any).resourceType).toBe("User");
        expect((error as any).resourceId).toBe("123");
      });
    });
    ...
    describe("ApiErrorMethodNotAllowed (405)", () => {
      ...
      it("should handle allowed methods", () => {
        ...
        expect(error.statusCode).toBe(405);
        expect((error as any).method).toBe("DELETE");
        expect((error as any).allowedMethods).toEqual(["GET", "POST", "PUT"]);
      });
    });
    ...
    describe("ApiErrorRequestTimeout (408)", () => {
      ...
      it("should handle timeout details", () => {
        ...
        expect(error.statusCode).toBe(408);
        expect((error as any).timeout).toBe(30000);
        expect((error as any).duration).toBe(35000);
      });
    });
    ...
    describe("ApiErrorConflict (409)", () => {
      ...
      it("should handle conflict details", () => {
        ...
        expect(error.statusCode).toBe(409);
        expect((error as any).conflictType).toBe("duplicate");
        expect((error as any).field).toBe("email");
        expect((error as any).value).toBe("test@example.com");
      });
    });
    ...
    describe("ApiErrorUnprocessableEntity (422)", () => {
      ...
      it("should handle semantic validation errors", () => {
        ...
        expect(error.statusCode).toBe(422);
        expect((error as any).semanticErrors).toBeDefined();
      });
    });
    ...
    describe("ApiErrorTooManyRequests (429)", () => {
      ...
      it("should handle rate limit details", () => {
        ...
        expect(error.statusCode).toBe(429);
        expect((error as any).limit).toBe(100);
        expect((error as any).windowMs).toBe(3600000);
        expect((error as any).retryAfter).toBe(1800);
      });
    });
    ...
    describe("ApiErrorInternalServerError (500)", () => {
      ...
      it("should handle error tracking details", () => {
        ...
        expect(error.statusCode).toBe(500);
        expect((error as any).errorId).toBe("error-123456");
        expect((error as any).component).toBe("database");
    ...
    describe("ApiErrorNotImplemented (501)", () => {
      ...
      it("should handle feature details", () => {
        ...
        expect(error.statusCode).toBe(501);
        expect((error as any).feature).toBe("advanced_search");
        expect((error as any).plannedRelease).toBe("2024.Q2");
      });
    });
    ...
    describe("ApiErrorServiceUnavailable (503)", () => {
      ...
      it("should handle maintenance details", () => {
        ...
        expect(error.statusCode).toBe(503);
        expect((error as any).maintenanceWindow).toBeDefined();
        expect((error as any).retryAfter).toBe(7200);
      });
    });
  });
